<div class="d-flex align-items-center justify-content-center">
    <link rel="stylesheet" href="{{ asset('style/usersidview.css') }}">
    ...
    <div class="col col-md-7">
        <form action="" method="post" class="adjust">
            ...
            <div class="input-group">
                ...
                <input type="text" name="contactnumber" id="contactnumber" class="form-control" value="{{ $user->contactnumber }}" readonly>
            </div>
            </div>
            <div class="form-group mb-2">
            ...
            <div class="form-group">
                <a href="{{ route('users.archive') }}" class="btn btn-danger">Go Back</a>
            </div>
        </form>
    </div>
</div>
