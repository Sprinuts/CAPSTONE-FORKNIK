<div class="d-flex align-items-center justify-content-center">
    ...
    <div class="col col-md-7">
        <form action="{{ url('users/edit/' . $user->id) }}" method="post" class="adjust">
            @csrf
            ...
            <div class="input-group">
                ...
                <option value="patient" {{ old('role', $user->role) == 'itso' ? 'selected' : '' }}>Patient</option>
                <option value="admin" {{ old('role', $user->role) == 'associate' ? 'selected' : '' }}>Admin</option>
